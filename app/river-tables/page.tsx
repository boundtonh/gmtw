...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Handcrafted river tables with custom epoxy inlay starting at $1,500. Two live edge slabs united by your choice of color and depth. Showrooms in Concord NH & Smithfield RI. In-home delivery across New England.',
  path: '/river-tables',
})
