...
const GALLERY_IMAGES = [
  { src: '/images/furniture-types/benches/b1.webp', alt: 'Custom live edge bench', title: 'Live Edge Bench' },
  { src: '/images/furniture-types/benches/b2.webp', alt: 'Handcrafted wood bench', title: 'Handcrafted Wood Bench' },
  { src: '/images/furniture-types/benches/b3.webp', alt: 'Custom bench with natural finish', title: 'Natural Finish Bench' },
  { src: '/images/furniture-types/benches/b4.webp', alt: 'Live edge dining bench', title: 'Dining Bench' },
  { src: '/images/furniture-types/benches/b5.webp', alt: 'Entryway bench with wood grain', title: 'Entryway Bench' },
]

export function BenchesGallery() {
