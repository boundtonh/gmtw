...
export function BenchesEstimatePromo() {
  return (
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Choose your wood species, dimensions, edge style, and base. Get an instant price starting at $500. Perfect for dining rooms, entryways, and mudrooms.
              </p>
