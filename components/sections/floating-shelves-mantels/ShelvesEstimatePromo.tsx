...
const specs = [
  'Wood species & shelf dimensions',
  'Fireplace mantel or floating shelf',
  'Length, depth & thickness',
  'Surface finish (matte or gloss)',
  'Concealed hardware install included',
  'Receive a custom quote',
]

export function ShelvesEstimatePromo() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              <SectionLabel>Custom Shelves &amp; Mantels</SectionLabel>

              <h2 className="font-display text-4xl md:text-5xl text-gmt-forest leading-tight mt-2 mb-6">
                Spec Your Shelving<br />Get a Custom Quote
              </h2>
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Tell us the dimensions, species, and finish you have in mind. We&apos;ll build a custom quote for your floating shelves or fireplace mantel — precision-fit with concealed hardware, typically quoted within 24 hours.
              </p>
