...
export function OceanHero() {
  ...
  return (
    <section className="relative min-h-screen md:min-h-[calc(68vh+105px)] flex items-end overflow-hidden bg-gmt-charcoal pt-[105px]">
      ...
      >
        <Image
          src="/images/ocean/Ocean-Table-Showroom.jpg"
          fill
          alt="Custom ocean table with epoxy handcrafted in New Hampshire — Green Mountain Tableworx"
          sizes="100vw"
      ...
      <div className="relative z-10 w-full max-w-[1320px] mx-auto px-6 md:px-12 xl:px-24 pb-16 md:pb-24">
        ...
        >
          Inspired by aerial views of coastlines and open water. Every ocean table is a one-of-a-kind piece built around your chosen colors, dimensions, and base — poured and finished by hand in New England.
        </motion.p>
