...
const specs = [
  ...
  'Epoxy color palette & depth',
  'Wave pattern & surface finish',
  'Custom base style',
  'Instant price quote',
]

export function OceanEstimatePromo() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              <SectionLabel>Custom Ocean Tables</SectionLabel>

              <h2 className="font-display text-4xl md:text-5xl text-gmt-forest leading-tight mt-2 mb-6">
                Design Your Ocean Table<br />Get An Instant Quote
              </h2>
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Create your custom ocean table — choose wood species, slab dimensions, epoxy colors inspired by water and coastlines, wave depth, and base style. Our estimator gives you an instant price. No phone call or visit needed.
              </p>
