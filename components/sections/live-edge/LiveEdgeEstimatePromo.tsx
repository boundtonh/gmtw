...
const specs = [
  'Wood species & live edge slab dimensions',
  'Edge contour & table shape',
  'Finish type & color',
  'Custom base style',
  'Instant price quote',
]

export function LiveEdgeEstimatePromo() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              <SectionLabel>Custom Live Edge Tables</SectionLabel>

              <h2 className="font-display text-4xl md:text-5xl text-gmt-forest leading-tight mt-2 mb-6">
                Design Your Live Edge Table<br />Get An Instant Quote
              </h2>
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Configure your custom live edge table — choose your wood species, slab dimensions, edge style, finish, and base. Our online estimator shows you the price instantly. No showroom visit or phone call required.
              </p>
