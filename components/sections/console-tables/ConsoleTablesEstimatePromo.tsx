...
const specs = [
  ...
  'Console length & depth',
  'Edge style (live edge or straight)',
  'Epoxy design or natural wood finish',
  'Custom base or leg style',
  'Instant price quote',
]

export function ConsoleTablesEstimatePromo() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              <SectionLabel>Custom Console Tables</SectionLabel>

              <h2 className="font-display text-4xl md:text-5xl text-gmt-forest leading-tight mt-2 mb-6">
                Design Your Console Table<br />Get An Instant Quote
              </h2>
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Choose your wood species, dimensions, edge style, and base. Get an instant price starting at $750. Sized perfectly for any entryway, hallway, or living space.
              </p>
