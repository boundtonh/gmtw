...
const ELEGANT_BASES = [
  ...
  { src: '/images/bases/Flowyline/Haru%20Pedestal.jpg',                alt: 'Haru Pedestal elegant iron base',      label: 'Haru Pedestal' },
  { src: '/images/bases/Flowyline/Lithe.jpg',                          alt: 'Lithe elegant iron base',              label: 'Lithe' },
  { src: '/images/bases/Flowyline/Lithe%20dining.jpg',                 alt: 'Lithe Dining iron base',               label: 'Lithe Dining' },
  { src: '/images/bases/Flowyline/Namu.jpg',                           alt: 'Namu elegant iron base',               label: 'Namu' },
  { src: '/images/bases/Flowyline/Namu%20coffee.jpg',                  alt: 'Namu Coffee elegant iron base',        label: 'Namu Coffee' },
  ...
  { src: '/images/bases/Flowyline/Wishbone%20Pedestal.jpg',            alt: 'Wishbone Pedestal iron base',          label: 'Wishbone Pedestal' },
  { src: '/images/bases/Flowyline/Wishbone%20coffee%20pedestal.jpg',   alt: 'Wishbone Coffee Pedestal',             label: 'Wishbone Coffee Pedestal' },
  { src: '/images/bases/Flowyline/Tulipe%20Dining.webp',               alt: 'Tulipe Dining elegant iron base',      label: 'Tulipe Dining' },
  { src: '/images/bases/Flowyline/Tulipe%20Pedestal.webp',             alt: 'Tulipe Pedestal iron base',            label: 'Tulipe Pedestal' },
  ...
  { src: '/images/bases/Flowyline/GMT%20Draco.jpg',                    alt: 'GMT Draco custom iron base',           label: 'GMT Draco' },
  { src: '/images/bases/Flowyline/Draco%20coffee.jpg',                 alt: 'Draco Coffee iron base',               label: 'Draco Coffee' },
  ...
  { src: '/images/bases/Flowyline/Kheops%20coffee.jpg',                alt: 'Kheops Coffee iron base',              label: 'Kheops Coffee' },
  { src: '/images/bases/Flowyline/kheops%20cookie.jpg',                alt: 'Kheops Cookie iron base',              label: 'Kheops Cookie' },
  ...
  { src: '/images/bases/Flowyline/Norah%20Dining.jpg',                 alt: 'Norah Dining iron base',               label: 'Norah Dining' },
  ...
  { src: '/images/bases/Flowyline/Yami%20Dining.jpg',                  alt: 'Yami Dining iron base',                label: 'Yami Dining' },
  { src: '/images/bases/Flowyline/Akro%20GOLD.jpg',                    alt: 'Akro Gold elegant iron base',          label: 'Akro Gold' },
