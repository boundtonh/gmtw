...
const ELEGANT_BASES = [
  { src: '/images/bases/Flowyline/Haru.jpg',                      alt: 'Haru premium iron base',               label: 'Haru' },
  { src: '/images/bases/Flowyline/Haru-Pedestal.jpg',             alt: 'Haru Pedestal premium iron base',      label: 'Haru Pedestal' },
  { src: '/images/bases/Flowyline/Lithe.jpg',                     alt: 'Lithe premium iron base',              label: 'Lithe' },
  { src: '/images/bases/Flowyline/Lithe-dining.jpg',              alt: 'Lithe Dining iron base',               label: 'Lithe Dining' },
  { src: '/images/bases/Flowyline/Namu.jpg',                      alt: 'Namu premium iron base',               label: 'Namu' },
  { src: '/images/bases/Flowyline/Namu-coffee.jpg',               alt: 'Namu Coffee premium iron base',        label: 'Namu Coffee' },
  { src: '/images/bases/Flowyline/Wineglass.jpg',                 alt: 'Wineglass premium iron base',          label: 'Wineglass' },
  { src: '/images/bases/Flowyline/Wishbone.jpg',                  alt: 'Wishbone premium iron base',           label: 'Wishbone' },
  ...
  { src: '/images/bases/Flowyline/Tulipe-Dining.webp',            alt: 'Tulipe Dining premium iron base',      label: 'Tulipe Dining' },
  { src: '/images/bases/Flowyline/Tulipe-Pedestal.webp',          alt: 'Tulipe Pedestal iron base',            label: 'Tulipe Pedestal' },
  { src: '/images/bases/Flowyline/Tulipe.jpg',                    alt: 'Tulipe premium iron base',             label: 'Tulipe' },
  { src: '/images/bases/Flowyline/Cleo.jpg',                      alt: 'Cleo premium iron base',               label: 'Cleo' },
  { src: '/images/bases/Flowyline/Curva.jpg',                     alt: 'Curva premium iron base',              label: 'Curva' },
  { src: '/images/bases/Flowyline/Draco.jpg',                     alt: 'Draco premium iron base',              label: 'Draco' },
  ...
  { src: '/images/bases/Flowyline/Faras.jpg',                     alt: 'Faras premium iron base',              label: 'Faras' },
  { src: '/images/bases/Flowyline/Kheops.jpg',                    alt: 'Kheops premium iron base',             label: 'Kheops' },
  ...
  { src: '/images/bases/Flowyline/Luma.jpg',                      alt: 'Luma premium iron base',               label: 'Luma' },
  { src: '/images/bases/Flowyline/Mamba.jpg',                     alt: 'Mamba premium iron base',              label: 'Mamba' },
  { src: '/images/bases/Flowyline/Norah.jpg',                     alt: 'Norah premium iron base',              label: 'Norah' },
  { src: '/images/bases/Flowyline/Norah-Dining.jpg',              alt: 'Norah Dining iron base',               label: 'Norah Dining' },
  { src: '/images/bases/Flowyline/Nura.jpg',                      alt: 'Nura premium iron base',               label: 'Nura' },
  { src: '/images/bases/Flowyline/Oria.jpg',                      alt: 'Oria premium iron base',               label: 'Oria' },
  { src: '/images/bases/Flowyline/Suma.jpg',                      alt: 'Suma premium iron base',               label: 'Suma' },
  { src: '/images/bases/Flowyline/Udo.jpg',                       alt: 'Udo premium iron base',                label: 'Udo' },
  { src: '/images/bases/Flowyline/Uta.jpg',                       alt: 'Uta premium iron base',                label: 'Uta' },
  { src: '/images/bases/Flowyline/Uzar.jpg',                      alt: 'Uzar premium iron base',               label: 'Uzar' },
  { src: '/images/bases/Flowyline/Xeni.jpg',                      alt: 'Xeni premium iron base',               label: 'Xeni' },
  { src: '/images/bases/Flowyline/Yami.jpg',                      alt: 'Yami premium iron base',               label: 'Yami' },
  { src: '/images/bases/Flowyline/Yami-Dining.jpg',               alt: 'Yami Dining iron base',                label: 'Yami Dining' },
  { src: '/images/bases/Flowyline/Akro-GOLD.jpg',                 alt: 'Akro Gold premium iron base',          label: 'Akro Gold' },
  { src: '/images/bases/Flowyline/Botas.jpg',                     alt: 'Botas premium iron base',              label: 'Botas' },
]
...
const DESCRIPTIONS: Record<Category, string> = {
  ...
  elegant:  'Premium iron bases with refined silhouettes and sophisticated design. Priced separately — inquire for availability.',
