...
const specs = [
  ...
  'Dining capacity & width',
  'Edge style (live edge, straight, or bevel)',
  'Epoxy or stain finish',
  'Custom base style',
  'Instant price quote',
]

export function DiningTablesEstimatePromo() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              <SectionLabel>Custom Dining Tables</SectionLabel>

              <h2 className="font-display text-4xl md:text-5xl text-gmt-forest leading-tight mt-2 mb-6">
                Design Your Dining Table<br />Get An Instant Quote
              </h2>
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Select your wood species, seating capacity, dining dimensions, edge style, finish, and base. Our estimator calculates your custom price instantly. No appointment or phone call needed.
              </p>
