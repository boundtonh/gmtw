    ...
    <section className="relative min-h-screen md:min-h-[calc(68vh+105px)] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 w-full h-full">
        <Image
          ...
          alt="Custom wood wall art and signage by Green Mountain Tableworx"
          fill
          priority
        ...
        <div className="max-w-[1320px] mx-auto w-full">
          <FadeUp delay={0.25}>
            <h1 className="font-display text-[2.5rem] md:text-[4rem] text-white leading-tight mb-6 max-w-2xl">
              Custom Wood Wall Art &amp; Signage
            </h1>
          </FadeUp>

          <FadeUp delay={0.4}>
            <p className="font-body text-base md:text-lg text-white/90 max-w-md mb-10">
              One-of-a-kind wood art, business signage, and personalized pieces. Every piece is handcrafted — the grain alone makes it unique.
            </p>
          </FadeUp>
