...
export function RiverEstimatePromo() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <RevealOnScroll direction="left">
            <div className="text-center lg:text-left">
              <SectionLabel>Custom River Tables</SectionLabel>

              <h2 className="font-display text-4xl md:text-5xl text-gmt-forest leading-tight mt-2 mb-6">
                Design Your River Table<br />Get An Instant Quote
              </h2>
              ...
              <p className="font-body text-base text-gmt-stone leading-relaxed max-w-md mb-8 lg:max-w-none">
                Build your custom river table — select wood species, slab dimensions, river width and depth, epoxy color, and base style. Our estimator calculates the price in minutes. Get your quote instantly without leaving home.
              </p>
